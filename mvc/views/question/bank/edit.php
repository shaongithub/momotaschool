...
<script type="text/javascript">
    ...
    $('#totalOption').change(function() {
        ...
        if(parseInt(valTotalOption) !=0) {
            ...
            var dbOption = "<?=count($dbTotalOptionID)?>";
    ...
    if(count($options) || count($answers)) {
        ...
        foreach ($options as $optionKey => $optionValue) {
            ...
            <script type="text/javascript">
                ...
                var optAns = '<?php if(count($answers)) { if(in_array($optionKey, $answers)){  echo 'checked="checked"'; } else { echo ''; } }?>';
